...
// TODO Zmienić odpowiedzi na wczytywanie po JsonPath?
...
public class BookControllerIT {
    ...
    public void shouldGetBookDetails() {
        ...
        String isbn = "ISBN1";
        Book book = new BookBuilder().withName("Book1").withIsbn(isbn).withAuthor("Author1").withPages(200).createBook();
...
//        assertEquals("Book Updated successfully", message);
    ...
    public void shouldDeleteBook() {
        //Create a new book using the BookRepository API
        String isbn1 = "ISBN1";
        Book book = new BookBuilder().withName("Book1").withIsbn(isbn1).withAuthor("Author1").withPages(200).createBook();
        bookRepository.save(book);
    ...
    public void testGetAllBooksApi() {
        ...
        Book book1 = new BookBuilder().withName("Book1").withIsbn("ISBN1").withAuthor("Author1").withPages(200).createBook();
        bookRepository.save(book1);

        Book book2 = new BookBuilder().withName("Book2").withIsbn("ISBN2").withAuthor("Author2").withPages(200).createBook();
